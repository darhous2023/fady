...
const FAQS = [
  {
    ...
    a: "من صفحة السيارة اضغط \"احجز معاينة مجانية\"، هتتضاف لقائمة المعاينة، وبعدها تأكّد بياناتك في صفحة الحجز — هنتواصل معاك لتحديد الميعاد. أو ابعتلنا على واتساب مباشرة.",
  },
  {
  ...
  {
    q: "إزاي أتواصل معاكم؟",
    a: "عبر أيقونة الواتساب العائمة أسفل الصفحة، أو من رابط \"تواصل معنا\" في الفوتر — هنرد في أقرب وقت ممكن.",
  },
]
