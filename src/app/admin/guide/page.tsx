...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "قسم \"حماية الموقع\" في الإعدادات: حدود عدد المحاولات المسموحة لكل نوع طلب (تسجيل دخول، حجز معاينة، تتبّع، بحث، تقييم، كود خصم، رفع صورة) خلال فترة زمنية معيّنة — قابلة للتعديل بالكامل من هنا بدون أي تدخل في الكود، وبتُطبّق فورًا.",
    ],
  },
]
