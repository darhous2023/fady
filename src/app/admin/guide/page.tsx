...
const SECTIONS: Section[] = [
  ...
  },
  {
    ...
    steps: [
      "هذه البوابة (/new) لا تحتاج إدارة يدوية — تجلب الماركات والموديلات والفئات مباشرة من مصدر بيانات خارجي (CarAPI) في الوقت الفعلي.",
  ...
  },
  {
    ...
    steps: [
      "البانرات: صور ترويجية تظهر في أماكن مخصصة بالموقع.",
      "الخصومات: أكواد خصم (نسبة أو مبلغ ثابت) يقدر العميل يستخدمها.",
      "التقييمات: مراجعات العملاء المعروضة في قسم الآراء بالصفحة الرئيسية.",
  ...
  },
  {
    ...
    steps: [
      ...
      "الإعدادات: رقم الواتساب الرئيسي للمعرض ومعلومات عامة أخرى مستخدمة في أكثر من مكان بالموقع.",
    ],
  },
]
