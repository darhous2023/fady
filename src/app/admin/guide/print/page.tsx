...
const SECTIONS = [
  ...
  },
  {
    ...
    items: ["بيانات حية من مصدر خارجي — لا تحتاج إدارة يدوية. دورك: الرد على استفسارات واتساب الواردة منها."],
  },
  {
  ...
  },
  {
    ...
    items: ["أضف حسابًا منفصلًا لكل شخص عنده صلاحية دخول — لا تشارك كلمة مرور واحدة.", "رقم الواتساب الرئيسي وبيانات عامة أخرى من قسم الإعدادات."],
  },
]
