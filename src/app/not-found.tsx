...
export default function NotFound() {
  return (
    <div style={{
      ...
      <style>{`
        @import url('https://fonts.googleapis.com/css2?family=Tajawal:wght@400;700;800&family=Cinzel:wght@400&family=Playfair+Display:wght@700&display=swap');
      ...
      <div style={{
        fontFamily: "Cinzel, serif", fontSize: 80, fontWeight: 700, lineHeight: 1,
      ...
      <div style={{ fontFamily: "Cinzel, serif", fontSize: 10, letterSpacing: "6px", color: "#C9A84C", opacity: 0.5, marginBottom: 20 }}>
        PAGE NOT FOUND
      </div>

      <h1 style={{ fontFamily: "Tajawal, sans-serif", fontSize: 24, fontWeight: 700, color: "#F5EFE0", marginBottom: 12 }}>
        الصفحة غير موجودة
      </h1>
      <p style={{ fontFamily: "Tajawal, sans-serif", fontSize: 15, color: "rgba(245,239,224,0.45)", marginBottom: 40, maxWidth: 360, lineHeight: 1.8 }}>
