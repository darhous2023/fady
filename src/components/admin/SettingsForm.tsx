...
export default function SettingsForm({ settings }: { settings: Record<string, string> }) {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    const textKeys = ["whatsapp_number", "store_name_ar", "store_tagline_ar", "instagram_url", "facebook_url", "tiktok_url", "logo_url", "intro_tagline_ar", "announcement_text", "flash_deals_title_ar", "flash_deals_ends_at"];
    const updates = [
