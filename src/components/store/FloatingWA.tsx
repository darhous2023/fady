...
export default function FloatingWA() {
  ...
  return (
    <>
      <style>{`
        @keyframes waPulse {
          0%, 100% { box-shadow: 0 0 0 0 rgba(37,211,102,0.45), 0 8px 32px rgba(37,211,102,0.25); }
          50%       { box-shadow: 0 0 0 10px rgba(37,211,102,0), 0 8px 32px rgba(37,211,102,0.35); }
        }
        .wa-fab {
