  ...
  return (
    <>
      <style>{`
        ...
        .cd-item:hover { background: rgba(155,163,170,0.04); }
        .cd-qty-btn { background: none; border: 1px solid rgba(155,163,170,0.2); color: #9BA3AA; width: 26px; height: 26px; border-radius: 6px; cursor: pointer; font-size: 16px; display: flex; align-items: center; justify-content: center; transition: all 0.2s; font-family: Tajawal, sans-serif; }
        .cd-qty-btn:hover { background: rgba(155,163,170,0.12); border-color: rgba(155,163,170,0.5); }
        .cd-remove { background: none; border: none; cursor: pointer; color: rgba(242,240,236,0.25); transition: color 0.2s; padding: 4px; }
        .cd-remove:hover { color: #D9776A; }
      `}</style>
      ...
      <div style={{
        ...
        borderLeft: "1px solid rgba(155,163,170,0.15)",
        ...
        <div style={{
          ...
          padding: "20px 24px", borderBottom: "1px solid rgba(155,163,170,0.1)",
          flexShrink: 0,
        }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#9BA3AA" strokeWidth="1.7" strokeLinecap="round" strokeLinejoin="round">
          ...
          <button onClick={closeCart} style={{
            background: "none", border: "1px solid rgba(155,163,170,0.2)", cursor: "pointer",
            color: "rgba(242,240,236,0.5)", borderRadius: 8, padding: "6px 10px",
            fontFamily: "Tajawal, sans-serif", fontSize: 13, transition: "all 0.2s",
            display: "flex", alignItems: "center", gap: 4,
          }}
            onMouseEnter={e => { e.currentTarget.style.color = "#F2F0EC"; e.currentTarget.style.borderColor = "rgba(155,163,170,0.4)" }}
            onMouseLeave={e => { e.currentTarget.style.color = "rgba(242,240,236,0.5)"; e.currentTarget.style.borderColor = "rgba(155,163,170,0.2)" }}
          >
            ...
            items.map(item => (
              <div key={item.id} className="cd-item" style={{
                ...
                <Link href={`/products/${item.slug}`} onClick={closeCart} style={{ flexShrink: 0 }}>
                  <div style={{ width: 72, height: 72, borderRadius: 10, overflow: "hidden", border: "1px solid rgba(155,163,170,0.12)" }}>
                    {item.image
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <Link href={`/products/${item.slug}`} onClick={closeCart} style={{ textDecoration: "none" }}>
                    <p style={{ fontFamily: "Tajawal, sans-serif", fontSize: 13, fontWeight: 700, color: "#F2F0EC", margin: "0 0 3px", lineHeight: 1.4, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                      {item.name_ar}
                    </p>
                  </Link>
                  <p style={{ fontFamily: "Tajawal, sans-serif", fontSize: 11, color: "rgba(242,240,236,0.35)", margin: "0 0 8px" }}>
                  ...
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                      ...
                      <span style={{ fontFamily: "Tajawal, sans-serif", fontSize: 14, fontWeight: 700, color: "#F2F0EC", minWidth: 20, textAlign: "center" }}>{item.quantity}</span>
                      <button className="cd-qty-btn" onClick={() => updateQty(item.id, item.quantity + 1)}>+</button>
                    </div>
