...
- ~~EMAXCONNSESSION~~ — **RESOLVED**, verified live (see Stage F). Admin-session-drop (#78) needs one more dedicated E2E confirmation pass but has no known remaining blocker.
